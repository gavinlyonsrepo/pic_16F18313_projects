...
//NOTE: Fosc 16Mhz :Timer 1: Fosc/4 + 1:4 prescaler  : 65mS
//16mhz / 4 = 4/4,000,000 = .000001 S
//Time calculation =  (1/(Fosc/4) * 4) 
//Time = (16-bit register value) * (1/Internal Clock) * (Pre-scale)
//Internal Clock = Fosc/4
//Time = (16-bit register value) * CALC_S

#define CALC_US 1 // time calculation in uSeconds
#define CALC_S .000001 // time calculation in Seconds
